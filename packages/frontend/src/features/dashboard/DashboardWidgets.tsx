...
import { type ContextTargetProps, entityTarget } from "#/components/context-menu/registry.ts";
import { Badge } from "@nookly/ui/components/badge";
import { Button } from "@nookly/ui/components/button";
import { refineJotIntoNote } from "#/features/notes/refine-jot.ts";
import { previewLines } from "#/features/notes/note-preview.ts";
import { TaskStatusIcon } from "#/features/tasks/task-properties.tsx";
import { parseDay, sortStatuses, statusKind, toDay } from "#/features/tasks/task-model.ts";
import { listSpaces } from "#/lib/api/spaces.ts";
import type { BriefingSession, PageSummary, Task, TaskStatus } from "#/lib/api/types.ts";
