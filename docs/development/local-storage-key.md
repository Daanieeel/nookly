...
| `nookly:tasks-display`              | JSON `{ tab, layout, grouping, ordering, showEmpty, properties }`                      | board grouped by status | [`src/features/tasks/task-model.ts`](../../src/features/tasks/task-model.ts)                       |
